...
class recursoCest
{
    ...
    {        
        ...
        [
            ...
            "total_filtrado"=> 15,
            "monto_acreditado"=> 0,
            "monto_baja"=> 324345.67,
            "monto_sin_acreditar"=> 0,
            "recurso_acreditado_cantidad"=> 0,
            "recurso_baja_cantidad"=> 15,
            "resultado"=> [
                [
                    "id"=> 40,
                    "fecha_inicial"=> "2017-12-01",
                ...
                [
                    "id"=> 33,
                    "fecha_inicial"=> "2017-12-08",
                    "fecha_alta"=> "2016-05-06",
                    "monto"=> 18123.7,
                    "observacion"=> "Observacion Fixture 33",
                    "proposito"=> "Un proposito hecho con fixtures 33",
                    "programaid"=> 2,
                    "tipo_recursoid"=> 3,
                    "personaid"=> 3,
                    "fecha_baja"=> "2018-01-07",
                    "fecha_acreditacion"=> "2016-05-07",
                    "descripcion_baja"=> null,
                    "programa"=> "Río Negro Presente",
                    "tipo_recurso"=> "Mejora Habitacional",
                    "baja"=> true,
                ...
                [
                    "id"=> 34,
                    "fecha_inicial"=> "2017-12-07",
                    "fecha_alta"=> "2016-05-05",
                    "monto"=> 16456.9,
                    "observacion"=> "Observacion Fixture 34",
                    "proposito"=> "Un proposito hecho con fixtures 34",
                    "programaid"=> 3,
                    "tipo_recursoid"=> 1,
                    "personaid"=> 4,
                    "fecha_baja"=> "2018-01-06",
                    "fecha_acreditacion"=> "2016-05-06",
                    "descripcion_baja"=> null,
                    "programa"=> "Emprender",
                    "tipo_recurso"=> "Alimentación",
                    "baja"=> true,
                ...
                [
                    ...
                    "tipo_recursoid"=> 3,
                    "personaid"=> 6,
                    "fecha_baja"=> "2018-01-04",
                    "fecha_acreditacion"=> "2016-05-04",
                    "descripcion_baja"=> null,
                    "programa"=> "Río Negro Presente",
                    "tipo_recurso"=> "Mejora Habitacional",
                    "baja"=> true,
