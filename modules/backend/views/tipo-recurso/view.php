...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            '<span class="glyphicon glyphicon-plus"></span> ' . 'New' . ' Programa',
            ['programa/create', 'Programa' => ['id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
  <?= Html::a(
            '<span class="glyphicon glyphicon-link"></span> ' . 'Attach' . ' Programa', ['tipo-recurso-has-programa/create', 'TipoRecursoHasPrograma'=>['tipo_recursoid'=>$model->id]],
...
<?=
 ...
 [
    ...
    'urlCreator' => function ($action, $model, $key, $index) {
        ...
        $params['TipoRecursoHasPrograma'] = ['tipo_recursoid' => $model->primaryKey()[0]];
        return $params;
    },
    'buttons'    => [
