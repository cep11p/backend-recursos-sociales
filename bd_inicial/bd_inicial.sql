...
) ENGINE=InnoDB AUTO_INCREMENT=25940 DEFAULT CHARSET=utf8;
...
INSERT INTO `auth_assignment` VALUES ('admin','2',1610454491),('prestacion_acreditar','2',1610454491),('prestacion_baja','2',1610454491),('prestacion_crear','2',1610031583),('prestacion_ver','2',1610031583);
...
INSERT INTO `user` VALUES (2,'admin','admin@correo.com','$2y$10$MnF9LJCnya.NrXIQBN4YGuRIdIuGtOSsGqqZTpby9RnFp7Chb4qEm','maXx0ibz2Br9UEfP06TVcltr0uOiWl4B',1556894840,NULL,NULL,'172.18.0.2',1556894840,1607700159,0,1610453141);
...
CREATE TABLE `user_persona` (
  ...
  `fecha_baja` date DEFAULT NULL,
  `descripcion_baja` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`userid`),
...
INSERT INTO `user_persona` VALUES (2,1,2626,NULL,NULL);
...
-- Dump completed on 2021-01-15 15:56:14
